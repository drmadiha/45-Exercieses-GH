...
let current_usernames = ['Shahab-u-Deen', 'Alamdeen', 'Mumtaz Hussain', 'Zaheer Babar', 'Tariq bin Ziyad'];
let new_usernames = ['ShaHab-u-DEEN', 'Mehmood Ghaznavi', 'Altamash', 'ZaHeer Babar', 'Tanveer Hussain'];
